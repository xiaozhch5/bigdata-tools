 ...
 * JSON解析工具
 */
package com.zh.ch.bigdata.json;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.zh.ch.bigdata.exception.JsonKeyNotFoundException;
...
public class JsonAnalysisUtil {
     ...
     * @throws JsonKeyNotFoundException 异常
     */
    public static JSONObject getJsonObject(JSONObject jsonObject, String key) throws ProjectException {
        if (jsonObject.getJSONObject(key) == null) {
            throw new JsonKeyNotFoundException(key);
        }
        else {
     ...
     * @throws JsonKeyNotFoundException 异常
     */
    public static JSONArray getJsonArray(JSONObject jsonObject, String key) throws ProjectException {
