...
//import com.ztesoft.zstream.flink.pkmanage.exception.PropertiesFileKeyNotFoundException;
...
///**
// * @author xzc
// * @description properties配置文件解析工具
// * @date 2021/01/05
// */
...
//     */
//    public static String getProperty(String propertiesFilePath, String key) throws IOException, ProjectException {
...
//    }
//
//    public static Properties loadProperties(String propertiesFilePath, Class configClass) throws ClassNotFoundException, IntrospectionException, IOException, ProjectException {
...
//     * @throws IOException 异常
//     */
//    public static String getPropertyWithoutProcessingException(String propertiesFilePath, String key) throws IOException {
//        Properties properties = new Properties();
//        InputStream inputStream = new FileInputStream(propertiesFilePath);
//        properties.load(inputStream);
