...
//import com.ztesoft.zstream.flink.pkmanage.common.PropertiesAnalyzeUtil;
...
//            this.mysqlConfigPropertiesFilePath = new MysqlClient().getResource(MysqlEnv.MYSQL_CONFIG_FILENAME);
//        }
//        String mysqlConnectionUrl = PropertiesAnalyzeUtil.getProperty(mysqlConfigPropertiesFilePath, MysqlEnv.MYSQL_CONNECTION_URL);
//        String mysqlUserName = PropertiesAnalyzeUtil.getProperty(mysqlConfigPropertiesFilePath, MysqlEnv.MYSQL_USERNAME);
//        String mysqlPassword = PropertiesAnalyzeUtil.getProperty(mysqlConfigPropertiesFilePath, MysqlEnv.MYSQL_PASSWORD);
//
//        try {
